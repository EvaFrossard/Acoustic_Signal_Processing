...
classdef HeaAudioDSP < HeaAudio
    ...
    properties (Hidden = true,Access = protected)
        hap = []; %handle to the dsp.audioDeviceWriter object
        har = []; %handle to the audioDeviceReader object
        isConstructed;
    end
    ...
    methods
        ...
        function play(obj,signalToPlay)
            ...
            %Play audio
            fprintf('DSP audioDeviceWriter utility running... ')
    ...
    methods (Hidden =  true, Access = protected)
        function obj = init(obj)
            ...
            if obj.isConstructed
                ...
                if ~isempty(obj.channelsPlay)
                    %Create the handle to the dsp.audioDeviceWriter
                    obj.hap = audioDeviceWriter( 'DeviceName',obj.devicePlayName,...
                        'SampleRate',obj.fs,...
                ...
                if ~isempty(obj.channelsRec)
                    %Create the handle to the audioDeviceReader
                    obj.har = audioDeviceReader( 'DeviceName',obj.deviceRecName,...
                        'SampleRate',obj.fs,...
                        'ChannelMappingSource','Property',...
